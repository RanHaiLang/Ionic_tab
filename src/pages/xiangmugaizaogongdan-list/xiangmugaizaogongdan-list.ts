...
import {XiangmugaizaoPage} from "./xiangmugaizao/xiangmugaizao";
import {HttpService} from "../../prodivers/httpService";
import {Storage} from "@ionic/storage";

/**
 * Generated class for the XiangmugaizaogongdanListPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-xiangmugaizaogongdan-list',
  templateUrl: 'xiangmugaizaogongdan-list.html',
})
export class XiangmugaizaogongdanListPage {
  ...
  url:string;
  org:string;
  constructor(public navCtrl: NavController, public navParams: NavParams,public app:App,public httpService:HttpService,public storage:Storage) {
      ...
      setTimeout(() => {
        this.httpService.get(url).subscribe((res)=>{
          ...
          for(let i=0;i<data['result'].length;i++){
            this.gaizaoList.push(data['result'][i])
          }
        })
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad XiangmugaizaogongdanListPage');
  }
