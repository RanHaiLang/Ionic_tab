!function (t, e) {
  ...
  return function (t) {
    ...
    t.exports = i(2), i(96), i(90), i(101), i(176), i(301), i(290), i(311), i(265), i(261), i(257), i(297), i(306), i(243), i(248), i(254), i(286), i(278), i(36), i(189), i(212), i(334), i(331), i(230), i(338), i(324), i(203), i(179), i(349), i(196), i(195), i(194), i(339), i(204), i(220)
  }, function (t, e) {
    function i(t) {
      if ("object" == typeof t && null !== t) {
        ...
        if (t instanceof Array) {
          e = [];
          for (var n = 0, o = t.length; n < o; n++)e[n] = i(t[n])
        } else if (!M(t) && !T(t)) {
          e = {};
    ...
    function r(t, e, i) {
      ...
      i = i || {}, "string" == typeof e && (e = tt[e]), this.id, this.group, this._dom = t, this._zr = D.init(t, {
        renderer: i.renderer || "canvas",
        devicePixelRatio: i.devicePixelRatio,
        width: i.width,
        height: i.height
      }), this._theme = P.clone(e), this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._api = new b(this), this._coordSysMgr = new w, z.call(this), this._messageCenter = new o, this._initEvents(), this.resize = P.bind(this.resize, this), this._pendingActions = [], O(J, n), O(Q, n), this._zr.animation.on("frame", this._onframe, this)
    }
    ...
    function u(t, e) {
      ...
      e[i ? "eachComponent" : "eachSeries"](function (t, a) {
        ...
        if (!l) {
          var u = M.parseClassType(a.type), h = i ? I.getClass(u.main, u.sub) : A.getClass(u.sub);
          if (!h)return;
    ...
    function p(t, e) {
      ...
      E(this._componentsViews, function (n) {
        var o = n.__model;
        n.render(o, t, i, e), v(o, n)
      }, this), E(this._chartsViews, function (t) {
        t.__alive = !1
      }, this), t.eachSeries(function (n, o) {
        var r = this._chartsMap[n.__viewId];
        r.__alive = !0, r.render(n, t, i, e), r.group.silent = !!n.get("silent"), v(n, r), m(n, r)
    ...
    function m(t, e) {
      ...
      var n = +t.get("progressive"), o = i > t.get("progressiveThreshold") && n && !x.node;
     ...
     */
    var x = i(11), _ = i(124), b = i(89), w = i(23), S = i(125), M = i(12), T = i(15), I = i(57), A = i(27), L = i(3), C = i(7), D = i(76), P = i(1), k = i(18), z = i(20), O = i(44), E = P.each, R = 1e3, N = 5e3, V = 1e3, B = 2e3, G = 3e3, F = 4e3, H = 5e3, W = "__flag_in_main_process", Z = "_hasGradientOrPatternBg", q = "_optionUpdated";
    o.prototype.on = n("on"), o.prototype.off = n("off"), o.prototype.one = n("one"), P.mixin(o, z);
    var j = r.prototype;
    j._onframe = function () {
      this[q] && (this[W] = !0, U.prepareAndUpdate.call(this), this[W] = !1, this[q] = !1)
    }, j.getDom = function () {
      return this._dom
    }, j.getZr = function () {
      return this._zr
      ...
      if (this[W] = !0, !this._model || e) {
        var n = new S(this._api), o = this._theme, r = this._model = new _(null, null, o, n);
        r.init(null, null, o, n)
      }
      this._model.setOption(t, K), i ? this[q] = !0 : (U.prepareAndUpdate.call(this), this._zr.refreshImmediately(), this[q] = !1), this[W] = !1, this._flushPendingActions()
    }, j.setTheme = function () {
      ...
      if (x.canvasSupported) {
        ...
        if (nt[e]) {
          ...
          P.each(it, function (o, h) {
            if (o.group === e) {
              var c = o.getRenderedCanvas(P.clone(t)), d = o.getDom().getBoundingClientRect();
          ...
          var c = s - r, d = l - a, f = P.createCanvas();
          f.width = c, f.height = d;
          var p = D.init(f);
          return E(u, function (t) {
            var e = new L.Image({style: {x: t.left * h - r, y: t.top * h - a, image: t.dom}});
            p.add(e)
          }), p.refreshImmediately(), f.toDataURL("image/" + (t && t.type || "png"))
        }
        return this.getDataURL(t)
      }
    }, j.convertToPixel = P.curry(a, "convertToPixel"), j.convertFromPixel = P.curry(a, "convertFromPixel"), j.containPixel = function (t, e) {
      var i, n = this._model;
      return t = C.parseFinder(n, t), P.each(t, function (t, n) {
      ...
      var i = this._model;
      t = C.parseFinder(i, t, {defaultMainType: "series"});
    ...
    var U = {
      update: function (t) {
        ...
        if (e) {
          e.restoreData(), n.create(this._model, this._api), h.call(this, e, i), c.call(this, e), n.update(e, i), f.call(this, e, t), p.call(this, e, t);
          ...
          if (a.isSingleCanvas && a.isSingleCanvas()) o.configLayer(0, {clearColor: r}); else {
            if (!x.canvasSupported) {
              var s = k.parse(r);
              r = k.stringify(s, "rgb"), 0 === s[3] && (r = "transparent")
            }
            r.colorStops || r.image ? (o.configLayer(0, {clearColor: r}), this[Z] = !0, this._dom.style.background = "transparent") : (this[Z] && o.configLayer(0, {clearColor: null}), this[Z] = !1, this._dom.style.background = r)
          }
        }
        ...
        var e = this._model;
        u.call(this, "component", e), u.call(this, "chart", e), U.update.call(this, t)
      }
    };
    j.resize = function (t) {
      this[W] = !0, this._zr.resize(t);
      var e = this._model && this._model.resetOption("media");
      U[e ? "prepareAndUpdate" : "update"].call(this), this._loadingFX && this._loadingFX.resize(), this[W] = !1, this._flushPendingActions()
      ...
      var i = Y[t.type];
      if (i) {
        var n = i.actionInfo, o = n.update || "update";
        if (this[W])return void this._pendingActions.push(t);
        this[W] = !0;
        var r = [t], a = !1;
        t.batch && (a = !0, r = P.map(t.batch, function (e) {
          return e = P.defaults(P.extend({}, e), t), e.batch = null, e
        }));
        for (var s, l = [], u = "highlight" === t.type || "downplay" === t.type, h = 0; h < r.length; h++) {
          var c = r[h];
          s = i.action(c, this._model), s = s || P.extend({}, c), s.type = n.event || s.type, l.push(s), u && U[o].call(this, c)
        }
        "none" === o || u || (this[q] ? (U.prepareAndUpdate.call(this, t), this[q] = !1) : U[o].call(this, t)), s = a ? {
            type: n.event || t.type,
            batch: l
    ...
    var X = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"];
    j._initEvents = function () {
      E(X, function (t) {
        this._zr.on(t, function (e) {
          ...
          } else o && o.eventData && (i = P.extend({}, o.eventData));
    ...
    var Y = [], $ = {}, Q = [], K = [], J = [], tt = {}, et = {}, it = {}, nt = {}, ot = new Date - 0, rt = new Date - 0, at = "_echarts_instance_", st = {
      version: "3.3.1",
      dependencies: {zrender: "3.2.1"}
    };
    st.init = function (t, e, i) {
      var n = new r(t, e, i);
      return n.id = "ec_" + ot++, it[n.id] = n, t.setAttribute && t.setAttribute(at, n.id), y(n), n
    }, st.connect = function (t) {
      if (P.isArray(t)) {
        var e = t;
        t = null, P.each(e, function (e) {
          null != e.group && (t = e.group)
        }), t = t || "g_" + rt++, P.each(e, function (e) {
          e.group = t
        })
      }
      return nt[t] = !0, t
      ...
      P.isDom(t) ? t = st.getInstanceByDom(t) : "string" == typeof t && (t = it[t]), t instanceof r && !t.isDisposed() && t.dispose()
    ...
    st.extendComponentModel = function (t, e) {
      ...
      P.createCanvas = t
    }, st.registerVisual(B, i(138)), st.registerPreprocessor(i(132)), st.registerLoading("default", i(123)), st.registerAction({
      type: "highlight",
      event: "highlight",
      update: "highlight"
      ...
      event: "downplay",
      update: "downplay"
    }, P.noop), st.List = i(14), st.Model = i(10), st.graphic = i(3), st.number = i(4), st.format = i(9), st.matrix = i(19), st.vector = i(5), st.color = i(18), st.util = {}, E(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend", "defaults"], function (t) {
      st.util[t] = P[t]
    }), st.PRIORITY = {
      PROCESSOR: {FILTER: R, STATISTIC: N},
      VISUAL: {LAYOUT: V, GLOBAL: B, CHART: G, COMPONENT: F, BRUSH: H}
    }, t.exports = st
  }, function (t, e, i) {
    "use strict";
    function n(t) {
    ...
    var m = i(1), v = i(168), y = Math.round, x = i(6), _ = i(18), b = i(19), w = i(5), S = (i(29), {});
    S.Group = i(34), S.Image = i(48), S.Text = i(74), S.Circle = i(159), S.Sector = i(165), S.Ring = i(164), S.Polygon = i(161), S.Polyline = i(162), S.Rect = i(163), S.Line = i(160), S.BezierCurve = i(158), S.Arc = i(157), S.CompoundPath = i(152), S.LinearGradient = i(87), S.RadialGradient = i(153), S.BoundingRect = i(8), S.extendShape = function (t) {
      return x.extend(t)
    ...
    var o = i(37), r = i(1), a = i(28), s = i(148), l = i(63), u = l.prototype.getCanvasPattern, h = Math.abs;
    n.prototype = {
    ...
    var o = i(9), r = i(4), a = i(10), s = i(1), l = {};
    l.normalizeToArray = function (t) {
      ...
      return s.each(e, function (t, n) {
        if (s.isObject(t)) {
          ...
          for (var o = 0; o < i.length; o++) {
            var r = i[o].exist;
            if (!(i[o].option || null != r.id && null != t.id || null == t.name || l.isIdInner(t) || l.isIdInner(r) || r.name !== t.name + ""))return i[o].option = t, void(e[n] = null)
          }
        }
        ...
        if (s.isObject(t)) {
          for (var n = 0; n < i.length; n++) {
            var o = i[n].exist;
            if (!i[n].option && !l.isIdInner(o) && null == t.id) {
              i[n].option = t;
              break
            }
          }
      ...
      function i(t, e, i) {
        for (var n = 0, o = t.length; n < o; n++)for (var r = t[n].seriesId, a = l.normalizeToArray(t[n].dataIndex), s = i && i[r], u = 0, h = a.length; u < h; u++) {
          var c = a[u];
    ...
    var o = i(5), r = i(19), a = o.applyTransform, s = Math.min, l = Math.abs, u = Math.max;
    n.prototype = {
    ...
    function i(t) {
      var e = {}, i = {}, n = t.match(/Firefox\/([\d.]+)/), o = t.match(/MSIE\s([\d.]+)/) || t.match(/Trident\/.+?rv:(([\d.]+))/), r = t.match(/Edge\/([\d.]+)/);
      return n && (i.firefox = !0, i.version = n[1]), o && (i.ie = !0, i.version = o[1]), r && (i.edge = !0, i.version = r[1]), {
        browser: i,
        os: e,
        node: !1,
    ...
    var o = i(10), r = i(1), a = Array.prototype.push, s = i(43), l = i(21), u = i(13), h = o.extend({
      type: "component",
      id: "",
      name: "",
      mainType: "",
    ...
    var o = i(1), r = i(8), a = i(4), s = i(9), l = a.parsePercent, u = o.each, h = {}, c = ["left", "right", "top", "bottom", "width", "height"];
    h.box = n, h.vbox = o.curry(n, "vertical"), h.hbox = o.curry(n, "horizontal"), h.getAvailableSize = function (t, e, i) {
      ...
      e = o.extend(o.clone(e), {
        width: r.width,
        height: r.height
      }), e = h.getLayoutRect(e, i, n), t.attr("position", [e.x - r.x, e.y - r.y])
    ...
    (function (e) {
      ...
      var r = "undefined", a = "undefined" == typeof window ? e : window, s = typeof a.Float64Array === r ? Array : a.Float64Array, l = typeof a.Int32Array === r ? Array : a.Int32Array, u = {
        ...
        number: Array,
        time: Array
      }, h = i(10), c = i(45), d = i(1), f = i(7), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"], m = function (t, e) {
    ...
    "use strict";
    var n = i(1), o = i(9), r = i(7), a = i(12), s = i(56), l = i(11), u = o.encodeHTML, h = o.addCommas, c = a.extend({
      ...
      mergeDefaultAndTheme: function (t, e) {
        n.merge(t, e.getTheme().get(this.subType)), n.merge(t, this.getDefaultOption()), r.defaultEmphasis(t.label, r.LABEL_OPTIONS), this.fillDataTextStyle(t.data)
      },
      mergeOption: function (t, e) {
      ...
      formatTooltip: function (t, e, i) {
        function r(t) {
          ...
          return n.each(t, function (t, n) {
            ...
            r = "ordinal" === l ? t + "" : "time" === l ? e ? "" : o.formatTime("yyyy/mm/dd hh:mm:ss", t) : h(t), r && i.push(r)
          }), i.join(", ")
        }

        var a = this._data, s = this.getRawValue(t), l = n.isArray(s) ? r(s) : h(s), c = a.getName(t), d = a.getItemVisual(t, "color"), f = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;background-color:' + d + '"></span>', p = this.name;
        return "\0-" === p && (p = ""), e ? f + u(this.name) + " : " + l : (p && u(p) + "<br />") + f + (c ? u(c) + " : " + l : l)
      },
    ...
    n.mixin(c, r.dataFormatMixin), n.mixin(c, s), t.exports = c
  }, function (t, e, i) {
    function n(t, e) {
      var i = t + ":" + e;
      if (l[i])return l[i];
    ...
    var n = i(136), o = i(38);
    i(137), i(135);
    var r = i(32), a = i(4), s = i(1), l = i(16), u = {};
    ...
    function o(t, e, i, n) {
      return i = i || {}, n ? r(t, e, i) : h.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (i.zrX = e.layerX, i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX, i.zrY = e.offsetY) : r(t, e, i), i
    }
    ...
    var a = i(34), s = i(43), l = i(21), u = i(7), h = i(1);
    n.prototype = {
    ...
    "use strict";
    var n = i(17), o = i(5), r = i(73), a = i(8), s = i(33).devicePixelRatio, l = {
      M: 1,
      L: 2,
      C: 3,
      Q: 4,
    ...
    var n = i(1), o = i(58), r = i(8), a = function (t) {
      t = t || {}, o.call(this, t);
    ...
    var u = i(14), h = i(30), c = i(1), d = i(7), f = i(23), p = d.getDataItemValue, g = d.converDataValue, m = {
      cartesian2d: function (t, e, i) {
        ...
        h(d, t, ["x", "y", "z"]);
        var g = {};
        return f && (g.x = o), p && (g.y = r), {dimensions: d, categoryIndex: f ? 0 : p ? 1 : -1, categoryAxesModels: g}
    ...
    i(54), i(106), r.extendComponentView({
    ...
    var o = i(1), r = i(64), a = i(58), s = i(75);
    n.prototype = {
      constructor: n,
      type: "displayable",
      __dirty: !0,
    ...
    var n = i(4), o = i(9), r = i(32), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, u = n.round, h = r.extend({
      type: "interval",
      _interval: 0,
    ...
    var r = i(3), a = i(49), s = n.prototype;
    ...
    var r = i(1), a = i(11), s = i(2), l = i(7), u = i(110), h = i(180), c = r.each, d = u.eachAxisDim, f = s.extendComponentModel({
      type: "dataZoom",
      ...
      type: "dataZoom", render: function (t, e, i, n) {
        ...
        return e.eachTargetAxis(function (e, a) {
          ...
          if (s) {
            ...
            var h = l ? i.queryComponents({mainType: l, index: s.get(l + "Index"), id: s.get(l + "Id")})[0] : null;
    ...
    t.exports = function (t, e, i, n, o) {
      n.eachRawSeriesByType(t, function (t) {
        ...
        o.setVisual({
          legendSymbol: i || r, symbol: r, symbolSize: a
    ...
    var o = i(37), r = i(8), a = i(1), s = i(150), l = new s(50);
    n.prototype = {
    ...
    var x = {
      axisLine: function () {
        ...
        if (r) {
          ...
          g = g * v / 180;
          for (var y = o(e, g, e.labelDirection), x = i.get("data"), b = [], w = a(i), S = i.get("triggerEvent"), M = 0; M < f.length; M++)if (!_(s, M, e.labelInterval)) {
            var T = c;
            x && x[M] && x[M].textStyle && (T = new h(x[M].textStyle, c, i.ecModel));
            var I = T.getTextColor() || i.get("axisLine.lineStyle.color"), A = s.dataToCoord(f[M]), L = [A, e.labelOffset + e.labelDirection * d], C = s.scale.getLabel(f[M]), D = new u.Text({
              anid: "label_" + f[M],
              style: {
                text: p[M],
    ...
    var n = i(81), o = i(1), r = i(12), a = i(13), s = ["value", "category", "time", "log"];
    ...
    var o = i(12), r = i(1), a = i(52), s = o.extend({
      type: "cartesian2dAxis", axis: null, init: function () {
        ...
        return this.ecModel.queryComponents({mainType: "grid", index: this.get("gridIndex"), id: this.get("gridId")})[0]
      }
    });
    r.merge(s.prototype, i(51)), r.merge(s.prototype, i(82));
    var l = {offset: 0};
    ...
    function o(t) {
      var e, i = t.model, n = i.getFormattedLabels(), o = 1, r = n.length;
      r > 40 && (o = Math.ceil(r / 40));
      for (var a = 0; a < r; a += o)if (!t.isLabelIgnored(a)) {
    ...
    var u = i(13), h = i(22), c = i(1), d = i(119), f = i(117), p = c.each, g = h.ifAxisCrossZero, m = h.niceScaleExtent;
    i(120);
    var v = r.prototype;
    ...
    var n = i(34), o = i(43), r = i(21), a = function () {
    ...
    "use strict";
    var n = i(62), o = i(20), r = i(88), a = i(166), s = i(1), l = function (t) {
    ...
    function p(t, e, i, n, o) {
      ...
      if (x) {
        ...
        if (!C) {
          for (var z = A[x - 1], D = 0; D < x - 1; D++)w ? l(A[D], z, T) : !isNaN(A[D]) || isNaN(z) || M || S || (A[D] = z);
          w && l(d(t._target, o), z, T);
          ...
          var W = function (t, e) {
            ...
            G = i, F = e;
            var n = I[i + 1] - I[i];
            if (0 !== n)if (E = (e - I[i]) / n, v)if (N = A[i], R = A[0 === i ? i : i - 1], V = A[i > x - 2 ? x - 1 : i + 1], B = A[i > x - 3 ? x - 1 : i + 2], w) h(R, N, V, B, E, E * E, E * E * E, d(t, o), T); else {
              var l;
    ...
    var o = i(7), r = i(1), a = i(11), s = i(9), l = s.addCommas, u = s.encodeHTML, h = i(2).extendComponentModel({
      type: "marker",
    ...
    function s(t, e) {
      ...
      return i[Math.round(m(e, [0, 1], [0, i.length - 1], !0))] || {}
    }
    ...
    var n = i(37), o = i(1), r = i(16), a = function (t) {
      n.call(this, t)
    };
    a.prototype = {
     ...
     */
    var o = i(62), r = i(11), a = i(139), s = i(142), l = i(143), u = i(151), h = !r.canvasSupported, c = {canvas: i(141)}, d = {}, f = {};
    ...
    var p = function (t, e, i) {
      ...
      var n = this, o = new s, d = i.renderer;
      if (h) {
        if (!c.vml)throw new Error("You need to require 'zrender/vml/vml' to support IE8");
        d = "vml"
      } else d && c[d] || (d = "canvas");
      var f = new c[d](e, o, i);
      this.storage = o, this.painter = f;
      var p = r.node ? null : new u(f.getViewportRoot());
      this.handler = new a(o, f, p, f.root), this.animation = new l({
        stage: {
          update: function () {
      ...
      var g = o.delFromMap, m = o.addToMap;
      o.delFromMap = function (t) {
        var e = o.get(t);
        g.call(o, t), e && e.removeSelfFromZr(n)
      }, o.addToMap = function (t) {
        m.call(o, t), t.addSelfToZr(n)
      }
    };
    p.prototype = {
    ...
    "use strict";
    var n = i(1), o = i(29), r = function (t, e, i, n, r, a) {
    ...
    i(97), i(98), o.registerVisual(n.curry(i(46), "line", "circle", "line")), o.registerLayout(n.curry(i(55), "line")), o.registerProcessor(r.PROCESSOR.STATISTIC, n.curry(i(134), "line")), i(36)
  }, function (t, e, i) {
    "use strict";
    var n = i(35), o = i(15);
    t.exports = o.extend({
    ...
    function l(t, e, i) {
      ...
      var f = new y.Rect({shape: {x: s, y: l, width: u, height: h}});
      return e && (f.shape[a ? "width" : "height"] = 0, y.initProps(f, {shape: {width: u, height: h}}, i)), f
    }

    function u(t, e, i) {
      var n = t.getAngleAxis(), o = t.getRadiusAxis(), r = o.getExtent(), a = n.getExtent(), s = Math.PI / 180, l = new y.Sector({
        shape: {
          cx: t.cx,
          cy: t.cy,
          r0: r[0],
    ...
    function f(t, e) {
      ...
      if (i && i.length && t.count()) {
        ...
        if (n && "cartesian2d" === e.type) {
          var r = n.dimension, a = t.dimensions[r], s = t.getDataExtent(a), l = n.stops, u = [];
          l[0].interval && l.sort(function (t, e) {
            return t.interval[0] - e.interval[0]
          });
          var h = l[0], c = l[l.length - 1], f = h.interval ? d(h.interval[0], s) : h.value, p = c.interval ? d(c.interval[1], s) : c.value, g = p - f;
          if (0 === g)return t.getItemVisual(0, "color");
          for (var o = 0; o < l.length; o++)if (l[o].interval) {
            if (l[o].interval[1] === l[o].interval[0])continue;
            u.push({
              offset: (d(l[o].interval[0], s) - f) / g,
              color: l[o].color
            }, {offset: (d(l[o].interval[1], s) - f) / g, color: l[o].color})
          } else u.push({offset: (l[o].value - f) / g, color: l[o].color});
          var m = new y.LinearGradient(0, 0, 0, 0, u, (!0)), v = e.getAxis(a), x = v.toGlobalCoord(v.dataToCoord(f)), _ = v.toGlobalCoord(v.dataToCoord(p));
    ...
    t.exports = b.extend({
      type: "line", init: function () {
        ...
        var C = f(l, r) || l.getVisual("color");
        x.useStyle(p.defaults(u.getLineStyle(), {fill: "none", stroke: C, lineJoin: "bevel"}));
        var D = t.get("smooth");
        if (D = o(t.get("smooth")), x.setShape({
          ...
          if (_.useStyle(p.defaults(d.getAreaStyle(), {fill: C, opacity: .7, lineJoin: "bevel"})), P) {
            var z = P.hostModel;
            k = o(z.get("smooth"))
          }
          _.setShape({
        ...
        var o = t.getData(), r = x.queryDataIndex(o, n);
        if (!(r instanceof Array) && null != r && r >= 0) {
          var a = o.getItemGraphicEl(r);
          if (!a) {
            var s = o.getItemLayout(r);
            a = new m(o, r), a.position = s, a.setZ(t.get("zlevel"), t.get("z")), a.ignore = isNaN(s[0]) || isNaN(s[1]), a.__temp = !0, o.setItemGraphicEl(r, a), a.stopSymbolAnimation(!0), this.group.add(a)
          }
          a.highlight()
        ...
        var r = this._polyline, a = this._polygon, s = t.hostModel, l = v(this._data, t, this._stackedOnPoints, e, this._coordSys, i), u = l.current, h = l.stackedOnCurrent, d = l.next, f = l.stackedOnNext;
        o && (u = c(l.current, i, o), h = c(l.stackedOnCurrent, i, o), d = c(l.next, i, o), f = c(l.stackedOnNext, i, o)), r.shape.__points = l.current, r.shape.points = u, y.updateProps(r, {shape: {points: d}}, s), a && (a.setShape({
          points: u,
          stackedOnPoints: h
    ...
    i(102), i(103), i(77)("pie", [{
      ...
      event: "pieunselected",
      method: "unSelect"
    }]), o.registerVisual(n.curry(i(72), "pie")), o.registerLayout(n.curry(i(105), "pie")), o.registerProcessor(n.curry(i(70), "pie"))
  }, function (t, e, i) {
    "use strict";
    var n = i(14), o = i(1), r = i(7), a = i(30), s = i(66), l = i(2).extendSeriesModel({
      type: "series.pie",
      init: function (t) {
    ...
    t.exports = function (t, e, i, n) {
      ...
      l.each(function (i) {
        ...
        var D = g.getModel("textStyle").getFont(), P = g.get("rotate") ? b < 0 ? -_ + Math.PI : -_ : 0, k = t.getFormattedLabel(i, "normal") || l.getName(i), z = r.getBoundingRect(k, D, d, "top");
        h = !!P, f.label = {
          x: n,
          y: o,
          position: m,
    ...
    t.exports = function (t, e, i, u) {
      e.eachSeriesByType(t, function (t) {
        ...
        if (v.each("value", function (t, e) {
          ...
          i.startAngle = A, i.endAngle = A + L * n, A += n
        });
        r(t, m, h, c)
      })
    }
    ...
    var o = i(1), r = i(3), a = i(50), s = a.ifIgnoreOnTick, l = a.getInterval, u = ["axisLine", "axisLabel", "axisTick", "axisName"], h = ["splitArea", "splitLine"], c = i(2).extendComponentView({
      type: "axis",
      render: function (t, e) {
        this.group.removeAll();
    ...
    var N = i(20), V = i(1), B = i(8), G = i(3), F = i(115), H = i(45), W = V.curry, Z = V.each, q = V.map, j = Math.min, U = Math.max, X = Math.pow, Y = 1e4, $ = 6, Q = 6, K = "globalPan", J = {
      w: [0, 0],
      e: [0, 1],
      n: [1, 0],
      s: [1, 1]
    ...
    var o = i(13), r = i(9), a = i(3);
    t.exports = {
      layout: function (t, e, i) {
        var r = o.getLayoutRect(e.getBoxLayoutParams(), {width: i.getWidth(), height: i.getHeight()}, e.get("padding"));
    ...
    function a(t, e) {
      ...
      p(e, function (t, e) {
        ...
        if (x(o)) {
          if (r.name = null != o.name ? o.name + "" : n ? n.name : "\0-",
              n) r.id = n.id; else if (null != o.id) r.id = o.id + ""; else {
            var a = 0;
            do r.id = "\0" + r.name + "\0" + a++; while (i[r.id])
          }
          i[r.id] = t
        }
      })
    ...
    var c = i(1), d = i(7), f = i(10), p = c.each, g = c.filter, m = c.map, v = c.isArray, y = c.indexOf, x = c.isObject, _ = i(12), b = i(126), w = "\0_ec_inner", S = f.extend({
      constructor: S,
      init: function (t, e, i, n) {
      ...
      mergeOption: function (t) {
        function e(e, o) {
          ...
          a(e, u);
          var h = r(n, o);
          i[e] = [], n[e] = [], p(u, function (t, o) {
            var r = t.exist, a = t.option;
            if (c.assert(x(a) || r, "Empty component definition"), a) {
              ...
              if (r && r instanceof s) r.name = t.keyInfo.name, r.mergeOption(a, this), r.optionUpdated(a, !1); else {
                var l = c.extend({dependentModels: h, componentIndex: o}, t.keyInfo);
                r = new s(a, this, this, l), c.extend(r, l), r.init(a, this, this, l), r.optionUpdated(null, !0)
              }
        ...
        }), _.topologicalTravel(o, _.getAllClassMainTypes(), e, this), this._seriesIndices = this._seriesIndices || []
      },
      getOption: function () {
    ...
    var u = i(1), h = i(7), c = i(12), d = u.each, f = u.clone, p = u.map, g = u.merge, m = /^(min|max)?(.+)$/;
    n.prototype = {
    ...
    var o = i(1), r = i(32), a = i(4), s = i(38), l = r.prototype, u = s.prototype, h = a.getPrecisionSafe, c = a.round, d = Math.floor, f = Math.ceil, p = Math.pow, g = Math.log, m = r.extend({
      type: "log",
      base: 10,
    ...
    var r = i(1), a = i(33), s = i(64), l = i(63), u = function (t, e, i) {
      var s;
    ...
    var o = i(1), r = i(11), a = i(34), s = i(44), l = function () {
    ...
    l.prototype = {
      constructor: l, traverse: function (t, e) {
        ...
        return t instanceof a && (t.__storage = this),
          t.dirty(!1), this._elements[t.id] = t, this
      }, get: function (t) {
    ...
    "use strict";
    var n = i(1), o = i(24).Dispatcher, r = i(60), a = i(59), s = function (t) {
    ...
    var n = i(61).normalizeRadian, o = 2 * Math.PI;
    t.exports = {
    ...
    var u = i(28).CMD, h = i(84), c = i(147), d = i(85), f = i(146), p = i(61).normalizeRadian, g = i(17), m = i(86), v = h.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
    t.exports = {
    ...
    var u = i(24), h = i(1), c = i(20), d = i(11), f = i(149), p = u.addEventListener, g = u.removeEventListener, m = u.normalizeEvent, v = 300, y = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"], x = ["touchstart", "touchend", "touchmove"], _ = {
      mousemove: function (t) {
        ...
        t = m(this.dom, t), this._lastTouchMoment = new Date, o(this, t, "start"), _.mousemove.call(this, t), _.mousedown.call(this, t), r(this)
      }, touchmove: function (t) {
        t = m(this.dom, t), o(this, t, "change"), _.mousemove.call(this, t), r(this)
      }, touchend: function (t) {
        t = m(this.dom, t), o(this, t, "end"), _.mouseup.call(this, t), +new Date - this._lastTouchMoment < v && _.click.call(this, t), r(this)
      }
    };
    ...
    "use strict";
    var n = i(1), o = i(29), r = function (t, e, i, n, r) {
    ...
    "use strict";
    var n = i(59), o = i(1), r = o.isString, a = o.isFunction, s = o.isObject, l = i(47), u = function () {
      this.animators = []
    };
    u.prototype = {
    ...
    var a = i(6), s = i(28), l = i(169), u = i(19), h = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], c = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
    ...
    var o = i(14), r = i(30), a = i(285), s = i(1), l = {
    ...
    var r = i(356), a = i(13), s = i(1), l = i(4), u = {}, h = {
    ...
    var n = i(1), o = i(2);
    i(177), i(178), o.registerVisual(n.curry(i(46), "scatter", "circle", null)), o.registerLayout(n.curry(i(55), "scatter")), i(36)
  }, function (t, e, i) {
    "use strict";
    var n = i(35), o = i(15);
    t.exports = o.extend({
    ...
    function o(t, e, i) {
      var n = i.getAxisModel(), o = n.axis.scale, a = [0, 100], s = [t.start, t.end], c = [];
      return e = e.slice(), r(e, n, o), u(["startValue", "endValue"], function (e) {
        c.push(null != t[e] ? o.parse(t[e]) : null)
      }), u([0, 1], function (t) {
        var i = c[t], n = s[t];
        null != n || null == i ? (null == n && (n = a[t]), i = o.parse(l.linearMap(n, a, e, !0))) : n = l.linearMap(i, e, a, !0), c[t] = i, s[t] = n
      }), {valueWindow: h(c), percentWindow: h(s)}
    }

    function r(t, e, i) {
      return u(["min", "max"], function (n, o) {
        var r = e.get(n, !0);
    ...
    function a(t, e) {
      ...
      if (n) {
        var r = e || 0 === n[0] && 100 === n[1], a = !e && l.getPixelPrecision(o, [0, 500]), s = !(e || a < 20 && a >= 0), u = e || r || s;
    ...
    var o = i(41), r = i(1), a = i(80), s = i(187), l = r.bind, u = o.extend({
    ...
    var o = i(1), r = i(3), a = i(83), s = i(41), l = r.Rect, u = i(4), h = u.linearMap, c = i(13), d = i(80), f = u.asc, p = o.bind, g = o.each, m = 7, v = 1, y = 30, x = "horizontal", _ = "vertical", b = 5, w = ["line", "bar", "candlestick", "scatter"], S = s.extend({
      type: "dataZoom.slider",
      init: function (t, e) {
      ...
      _resetLocation: function () {
        ...
        this._location = {x: s.x, y: s.y}, this._size = [s.width, s.height], this._orient === _ && this._size.reverse()
      },
      ...
      _renderHandle: function () {
        ...
        n.add(t.filler = new l({
          ...
          style: {stroke: a.get("dataBackgroundColor") || a.get("borderColor"), lineWidth: v, fill: "rgba(0,0,0,0)"}
        })));
      ...
      _updateView: function () {
        ...
        g([0, 1], function (i) {
          var o = t.handles[i], r = this._handleHeight;
          o.attr({scale: [r, r], position: [e[i], n[1] / 2 - r / 2]})
        }, this), t.filler.setShape({x: i[0], y: 0, width: i[1] - i[0], height: n[1]}), this._updateDataInfo()
      },
      _updateDataInfo: function () {
        function t(t) {
          var e = r.getTransform(i.handles[t].parent, this.group), s = r.transformDirection(0 === t ? "right" : "left", e), l = this._handleWidth / 2 + b, h = r.applyTransform([u[t] + (0 === t ? -l : l), this._size[1] / 2], e);
          n[t].setStyle({
            x: h[0],
            y: h[1],
            textVerticalAlign: o === x ? "middle" : s,
            textAlign: o === x ? s : "center",
            text: a[t]
          })
        }

        var e = this.dataZoomModel, i = this._displayables, n = i.handleLabels, o = this._orient, a = ["", ""];
        if (e.get("showDetail")) {
          var s, l;
    ...
    var h = i(1), c = i(79), d = i(83), f = h.curry, p = "\0_ec_dataZoom_roams", g = {
      register: function (t, e) {
    ...
    t.exports = i(2).extendComponentView({
      type: "legend", init: function () {
        ...
        "string" == typeof S && S ? M = S.replace("{name}", t) : "function" == typeof S && (M = S(t));
        var T = new l.Text({
          style: {
            text: M,
            x: b,
        ...
        var I = new l.Rect({
          ...
          tooltip: y.get("show") ? a.extend({
              content: t, formatter: x.get("formatter", !0) || function () {
                return t
    ...
    var l = i(1), u = i(14), h = i(4), c = i(69), d = i(95), f = function (t, e, i, n) {
    ...
    var r = i(39), a = i(1), s = i(4), l = i(14), u = i(69);
    i(68).extend({
      ...
      return t.eachRawSeries(function (t) {
        ...
        if (!o || "cartesian2d" !== o.type && "polar" !== o.type) i.push(t); else {
          ...
          if ("category" === r.type) {
            ...
            e[a] || (e[a] = {categoryAxis: r, valueAxis: o.getOtherAxis(r), series: []}, n.push({
              axisDim: r.dim,
              axisIndex: r.index
            })), e[a].series.push(t)
          } else i.push(t)
    ...
    function h(t) {
      for (var e = t.split(/\n+/g), i = s(e.shift()), n = [], o = 0; o < e.length; o++) {
        ...
        isNaN(a[0]) ? (u = !0, l = a[0], a = a.slice(1), n[o] = {name: l, value: []}, r = n[o].value) : r = n[o] = [];
    ...
    r.onclick = function (t, e) {
      var i = this.model, n = i.get("name") || t.get("title.0.text") || "echarts", o = document.createElement("a"), r = i.get("type", !0) || "png";
      o.download = n + "." + r, o.target = "_blank";
      ...
      if (o.href = a, "function" == typeof MouseEvent) {
    ...
    function r(t) {
      ...
      return i && e.push(n(i)), r && (p.canvasSupported ? e.push("background-Color:" + r) : (e.push("background-Color:#" + u.toHex(r)), e.push("filter:alpha(opacity=70)"))), d(["width", "color", "radius"], function (i) {
        var n = "border-" + i, o = f(n), r = t.get(o);
        null != r && e.push(n + ":" + r + ("color" === i ? "" : "px"))
      }), e.push(o(a)), null != s && e.push("padding:" + c.normalizeCssArray(s).join("px ") + "px"), e.join(";") + ";"
    }
    ...
    var l = i(1), u = i(18), h = i(24), c = i(9), d = l.each, f = c.toCamelCase, p = i(11), g = ["", "-webkit-", "-moz-", "-o-"], m = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
    a.prototype = {
      constructor: a, enterable: !0, update: function () {
        ...
        var e = this.el;
        e.style.cssText = m + r(t) + ";left:" + this._x + "px;top:" + this._y + "px;" + (t.get("extraCssText") || ""), e.style.display = e.innerHTML ? "block" : "none", this._show = !0
    ...
    function u(t, e, i, n, o, r, a) {
      var u = a.getWidth(), h = a.getHeight(), c = r && r.getBoundingRect().clone();
      if (r && c.applyTransform(r.transform), "function" == typeof t && (t = t([e, i], o, n.el, c)), f.isArray(t)) e = v(t[0], u), i = v(t[1], h); else if ("string" == typeof t && r) {
        var d = l(t, c, n.el);
        e = d[0], i = d[1]
      } else {
    ...
    i(2).extendComponentView({
      type: "tooltip", _axisPointers: {}, init: function (t, e) {
        ...
        if (t.from !== this.uid) {
          var e = this._ecModel, i = t.seriesIndex, n = e.getSeriesByIndex(i), o = this._api;
          if (null == t.x || null == t.y) {
            if (n || e.eachSeries(function (t) {
                h(t) && !n && (n = t)
              }), n) {
              var r = n.getData(), a = m.queryDataIndex(r, t);
              if (null == a || f.isArray(a))return;
              var s, l, u = r.getItemGraphicEl(a), c = n.coordinateSystem;
            ...
            this._tryShow({offsetX: t.x, offsetY: t.y, position: t.position, target: u, event: {}})
          }
        }
        ...
        if (i)if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
          ...
          var c = new x(u, i), d = c.get("content"), f = Math.random();
        ...
        f.each(this._seriesGroupByAxis, function (t) {
          ...
          s = a.dataToPoint(h);
          var c = a.getBaseAxis(), d = o.get("axis");
          "auto" === d && (d = c.dim);
          var p = !1, g = this._lastHover;
          if ("cross" === r) n(g.data, h) && (p = !0), g.data = h; else {
            var m = f.indexOf(l, d);
            g.data === h[m] && (p = !0), g.data = h[m]
          }
          "cartesian2d" !== a.type || p ? "polar" !== a.type || p ? "singleAxis" !== a.type || p || this._showSinglePointer(o, a, d, s) : this._showPolarPointer(o, a, d, s) : this._showCartesianPointer(o, a, d, s), "cross" !== r && this._dispatchAndShowSeriesTooltipContent(a, t.series, s, h, p, i.position)
        }, this), this._tooltipModel.get("show") || this._hideAxisPointer(), u && this._hide()
      }, _showCartesianPointer: function (t, e, i, n) {
        function a(i, n, r) {
          var a = "x" === i ? o(n[0], r[0], n[0], r[1]) : o(r[0], n[1], r[1], n[1]), s = l._getPointerElement(e, t, i, a);
          d.subPixelOptimizeLine({shape: a, style: s.style}), c ? d.updateProps(s, {shape: a}, t) : s.attr({shape: a})
        }

        function s(i, n, o) {
          var a = e.getAxis(i), s = a.getBandWidth(), u = o[1] - o[0], h = "x" === i ? r(n[0] - s / 2, o[0], s, u) : r(o[0], n[1] - s / 2, u, s), f = l._getPointerElement(e, t, i, h);
        ...
        function r(i, n, r) {
          var s = e.getAxis(), u = s.orient, h = "horizontal" === u ? o(n[0], r[0], n[0], r[1]) : o(r[0], n[1], r[1], n[1]), c = a._getPointerElement(e, t, i, h);
        ...
        function r(i, n, r) {
          ...
          if ("angle" === i) {
            var u = e.coordToPoint([r[0], s[1]]), h = e.coordToPoint([r[1], s[1]]);
            a = o(u[0], u[1], h[0], h[1])
        ...
        function s(i, n, o) {
          var r, s = e.getAxis(i), u = s.getBandWidth(), h = e.pointToCoord(n), c = Math.PI / 180;
          r = "angle" === i ? a(e.cx, e.cy, o[0], o[1], (-h[1] - u / 2) * c, (-h[1] + u / 2) * c) : a(e.cx, e.cy, h[0] - u / 2, h[0] + u / 2, 0, 2 * Math.PI);
          var p = l._getPointerElement(e, t, i, r);
          f ? d.updateProps(p, {shape: r}, t) : p.attr({shape: r})
        }

        var l = this, u = t.get("type"), h = e.getAngleAxis(), c = e.getRadiusAxis(), f = "cross" !== u && "category" === e.getBaseAxis().type;
        if ("cross" === u) r("angle", n, c.getExtent()), r("radius", n, h.getExtent()), this._updateCrossText(e, n, t); else {
        ...
        var g = s[l][i] = new d[p]({style: f, z: r, zlevel: a, silent: !0, shape: n});
        return this.group.add(g), g
      }, _dispatchAndShowSeriesTooltipContent: function (t, e, i, n, o, r) {
        var a = this._tooltipModel, s = t.getBaseAxis(), l = "x" === s.dim || "radius" === s.dim ? 0 : 1, h = f.map(e, function (t) {
          return {
            seriesIndex: t.seriesIndex,
        ...
        if (c.payloadBatch && !o && d.dispatchAction({
            type: "downplay",
            batch: c.payloadBatch
          }), o || (d.dispatchAction({
            type: "highlight",
            batch: h
          }), c.payloadBatch = h), d.dispatchAction({
            type: "showTip",
          ...
          if (o) u(r || a.get("position"), i[0], i[1], this._tooltipContent, p, null, d); else {
            var g = h[0].dataIndexInside, m = "time" === s.type ? s.scale.getLabel(n[l]) : e[0].getData().getName(g), v = (m ? m + "<br />" : "") + f.map(e, function (t, e) {
                return t.formatTooltip(h[e].dataIndexInside, !0)
              }).join("<br />"), y = "axis_" + t.name + "_" + g;
            this._showTooltipContent(a, v, p, y, i[0], i[1], r, null, d)
          }
        }
        ...
        var u = this._tooltipModel, h = t.getModel("tooltip", u), c = new x(s, h, h.ecModel), d = t.getDataParams(e, i), f = t.formatTooltip(e, !1, i), p = "item_" + t.name + "_" + e;
        ...
        if (this._ticket = "", t.get("showContent") && t.get("show")) {
          var h = this._tooltipContent, c = t.get("formatter");
          a = a || t.get("position");
          var d = e;
          if (c)if ("string" == typeof c) d = p.formatTpl(c, i); else if ("function" == typeof c) {
            var f = this, g = n, m = function (t, e) {
              t === f._ticket && (h.setContent(e), u(a, o, r, h, i, s, l))
            };
            f._ticket = g, d = c(i, g, m)
          }
          h.show(t), h.setContent(d), u(a, o, r, h, i, s, l)
        }
    ...
    var a = i(369), s = i(4), l = (i(1), i(22)), u = l.niceScaleExtent;
    i(370);
    var h = {
    ...
    if (!i(11).canvasSupported) {
      var n = i(5), o = i(8), r = i(28).CMD, a = i(18), s = i(16), l = i(75), u = i(37), h = i(48), c = i(74), d = i(6), f = i(29), p = i(170), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", S = "progid:DXImageTransform.Microsoft", M = 21600, T = M / 2, I = 1e5, A = 1e3, L = function (t) {
        ...
        if (null != n)if (n instanceof f) {
          ...
          if (I >= 2) {
            var k = A[0][0], z = A[1][0], O = A[0][1] * e.opacity, N = A[1][1] * e.opacity;
            t.type = o, t.method = "none", t.focus = "100%", t.angle = r, t.color = k, t.color2 = z, t.colors = L.join(","), t.opacity = N, t.opacity2 = O
          }
        ...
        for (a = 0; a < t.length;) {
          switch (o = t[a++], n = "", i = 0, o) {
            ...
            case d:
              ...
              a++;
              var F = t[a++], H = O + y(V) * R, W = E + x(V) * N, S = O + y(B) * R, I = E + x(B) * N, Z = F ? " wa " : " at ";
              Math.abs(H - S) < 1e-10 && (Math.abs(B - V) > .01 ? F && (H += 270 / M) : Math.abs(W - E) < 1e-10 ? F && H < O || !F && H > O ? I -= 270 / M : I += 270 / M : F && W < E || !F && W > E ? S += 270 / M : S -= 270 / M), p.push(Z, g(((O - R) * P + C) * M - T), w, g(((E - N) * k + D) * M - T), w, g(((O + R) * P + C) * M - T), w, g(((E + N) * k + D) * M - T), w, g((H * P + C) * M - T), w, g((W * k + D) * M - T), w, g((S * P + C) * M - T), w, g((I * k + D) * M - T)), s = S, l = I;
              break;
            case r.R:
              var q = G[0], j = G[1];
      ...
      h.prototype.brushVML = function (t) {
        ...
        if (o) {
          ...
          if (this.transform && (I = this.transform, D = m(I[0] * I[0] + I[1] * I[1]), k = m(I[2] * I[2] + I[3] * I[3]), C = I[1] || I[2]), C) {
            ...
            b(O, O, I), b(E, E, I), b(R, R, I), b(N, N, I);
            var V = _(O[0], E[0], R[0], N[0]), B = _(O[1], E[1], R[1], N[1]), G = [];
            G.push("M11=", I[0] / D, w, "M12=", I[2] / k, w, "M21=", I[1] / D, w, "M22=", I[3] / k, w, "Dx=", g(u * D + I[4]), w, "Dy=", g(h * k + I[5])), A.padding = "0 " + g(V) + "px " + g(B) + "px 0", A.filter = S + ".Matrix(" + G.join("") + ", SizingMethod=clip)"
          ...
          var X = "", Y = n.opacity;
          Y < 1 && (X += ".Alpha(opacity=" + g(100 * Y) + ") "), X += S + ".AlphaImageLoader(src=" + o + ", SizingMethod=scale)", Z.filter = X, T.style.zIndex = z(this.zlevel, this.z, this.z2), P(t, T), n.text && this.drawRectText(t, this.getBoundingRect())
        }
      ...
      for (var $ = new o, Q = function (t, e, i, n) {
        ...
        if (r) {
          ...
          B(A, "fill", {
            ...
            opacity: o.opacity,
            lineDash: o.lineDash
          }, this), A.style.zIndex = z(this.zlevel, this.z, this.z2), P(t, A)
        }
      }, K = function (t) {
    ...
    var n = i(14), o = i(379), r = i(241), a = i(30), s = i(23), l = i(1), u = i(35);
    ...
    function o(t, e, i, n) {
      e.off("click"), t.get("selectedMode") && e.on("click", function (o) {
        for (var a = o.target; !a.__region;)a = a.parent;
        if (a) {
          var s = a.__region, l = {
          ...
          l[t.mainType + "Id"] = t.id, i.dispatchAction(l), r(t, e)
        }
      })
    }
      ...
      constructor: a, draw: function (t, e, i, a, s) {
        ...
        u.each(c.regions, function (e) {
          ...
          if (h) h.setItemGraphicEl(r, i); else {
            ...
            o.eventData = {componentType: "geo", geoIndex: t.componentIndex, name: e.name, region: a && a.option || {}}
          }
          i.__region = e, l.setHoverStyle(i, x), d.add(i)
        }), this._updateController(t, e, i), o(t, d, i, a), r(t, d)
      }, remove: function () {
        ...
        r.off("pan").on("pan", function (t, e) {
          ...
          if (i.dispatchAction(u.extend(n(), {zoom: t, originX: e, originY: o})), this._updateGroup) {
    ...
    }), n.registerPreprocessor(i(366))
  }, function (t, e, i) {
    var n = i(2), o = i(1), r = i(11), a = i(383), s = i(71), l = i(173), u = s.mapVisual, h = i(7), c = s.eachVisual, d = i(4), f = o.isArray, p = o.each, g = d.asc, m = d.linearMap, v = o.noop, y = ["#f6efa6", "#d88273", "#bf444c"], x = n.extendComponentModel({
      type: "visualMap",
      dependencies: ["series"],
    ...
    var n = i(1), o = i(3), r = i(9), a = i(13), s = i(2), l = i(71);
    ...
    i(12).registerSubTypeDefaulter("visualMap", function (t) {
      ...
      t.eachSeries(function (e) {
        ...
        t.eachComponent("visualMap", function (t) {
          if (t.isTargetSeries(e)) {
            var o = {};
            n.push(o), o.stops = t.getStops(e, r), o.dimension = t.getDataDimension(i)
          }
    ...
    function r(t, e, i) {
      ...
      for (var r = t.targetVisuals[i], a = l.prepareVisualTypes(r), s = {}, u = 0, h = a.length; u < h; u++) {
        var c = a[u], d = r["colorAlpha" === c ? "__alphaForOpacity" : c];
        d && d.applyVisual(e, n, o)
      }
      return s.color
    }

    var a = i(2), s = i(173), l = i(71);
    ...
    u.mixin(n, l), o.prototype = {
      ...
      containPoint: function (t) {
        return this.getViewRect().contain(t[0], t[1])
      }
    ...
    var o = i(242), r = i(8), a = i(73), s = i(5);
    n.prototype = {
    ...
    var n = i(2);
    i(244), i(245), n.registerVisual(i(247)), n.registerLayout(i(246))
  }, function (t, e, i) {
    "use strict";
    ...
    t.exports = function (t, e) {
      ...
      t.eachRawSeriesByType("boxplot", function (e) {
        ...
        r.setVisual({legendSymbol: "roundRect", color: e.get(i) || o}), t.isSeriesFiltered(e) || r.each(function (t) {
    ...
    var n = i(2);
    i(249), i(250), n.registerPreprocessor(i(253)), n.registerVisual(i(252)), n.registerLayout(i(251))
  }, function (t, e, i) {
    "use strict";
    ...
    var n = i(1), o = i(2);
    i(255), i(256), o.registerVisual(n.curry(i(46), "effectScatter", "circle", null)), o.registerLayout(n.curry(i(55), "effectScatter"))
  }, function (t, e, i) {
    "use strict";
    var n = i(35), o = i(15);
    t.exports = o.extend({
    ...
    var n = i(1), o = i(2);
    i(258), i(259), o.registerVisual(n.curry(i(72), "funnel")), o.registerLayout(i(260)), o.registerProcessor(n.curry(i(70), "funnel"))
  }, function (t, e, i) {
    "use strict";
    var n = i(14), o = i(7), r = i(30), a = i(2).extendSeriesModel({
      type: "series.funnel",
      init: function (t) {
    ...
    var r = i(264), a = i(3), s = i(4), l = s.parsePercent, u = 2 * Math.PI, h = i(27).extend({
      type: "gauge",
      render: function (t, e, i) {
        this.group.removeAll();
      ...
      _renderTicks: function (t, e, i, n, r, u, h, c) {
        for (var d = this.group, f = r.cx, p = r.cy, g = r.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), b = t.get("splitNumber"), w = x.get("splitNumber"), S = l(y.get("length"), g), M = l(x.get("length"), g), T = u, I = (h - u) / b, A = I / w, L = y.getModel("lineStyle").getLineStyle(), C = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; P <= b; P++) {
          ...
          if (y.get("show")) {
            var O = new a.Line({
              shape: {x1: k * g + f, y1: z * g + p, x2: k * (g - S) + f, y2: z * (g - S) + p},
              style: L,
              silent: !0
            });
          ...
          if (_.get("show")) {
            var E = o(s.round(P / b * (v - m) + m), _.get("formatter")), R = _.get("distance"), N = new a.Text({
              style: {
                text: E,
                x: k * (g - S - R) + f,
                y: z * (g - S - R) + p,
                fill: D.getTextColor(),
                textFont: D.getFont(),
                textVerticalAlign: z < -.4 ? "top" : z > .4 ? "bottom" : "middle",
          ...
          if (x.get("show") && P !== b) {
            for (var V = 0; V <= w; V++) {
              ...
              "auto" === C.stroke && B.setStyle({stroke: n((P + V / w) / b)}), d.add(B), T += A
            }
            T -= A
          } else T += I
        }
    ...
    var n = i(2), o = i(1);
    i(266), i(267), i(276), n.registerProcessor(i(269)), n.registerVisual(o.curry(i(46), "graph", "circle", null)), n.registerVisual(i(270)), n.registerVisual(i(273)), n.registerLayout(i(277)), n.registerLayout(i(271)), n.registerLayout(i(275)), n.registerCoordinateSystem("graphView", {create: i(272)})
  }, function (t, e, i) {
    "use strict";
    var n = i(14), o = i(1), r = i(7), a = i(10), s = i(228), l = i(2).extendSeriesModel({
      type: "series.graph",
      init: function (t) {
        l.superApply(this, "init", arguments), this.legendDataProvider = function () {
    ...
    var o = i(39), r = i(95), a = i(79), s = i(3), l = i(268), u = i(1), h = ["itemStyle", "normal", "opacity"], c = ["lineStyle", "normal", "opacity"];
    i(2).extendChartView({
    ...
    var n = i(274), o = i(4), r = i(225), a = i(223), s = i(5), l = i(1);
    t.exports = function (t) {
      t.eachSeriesByType("graph", function (t) {
        var e = t.coordinateSystem;
        if (!e || "view" === e.type)if ("force" === t.get("layout")) {
          ...
          var y = h.mapArray("value", function (t, e) {
            ...
            return isNaN(n) && (n = (m[0] + m[1]) / 2), {w: n, rep: n, p: !i || isNaN(i[0]) || isNaN(i[1]) ? null : i}
    ...
    var n = i(2), o = i(222), r = {type: "graphRoam", event: "graphRoam", update: "none"};
    ...
    var o = i(227), r = i(1), a = i(226), s = i(5), l = n.prototype;
    ...
    function o(t, e) {
      t.eachChild(function (t) {
        t.attr({
          z: e.z,
          zlevel: e.zlevel,
          style: {stroke: "stroke" === e.brushType ? e.color : null, fill: "fill" === e.brushType ? e.color : null}
        })
      })
    }
    ...
    var a = i(1), s = i(26), l = i(3), u = i(4), h = i(49), c = l.Group, d = 3, f = r.prototype;
    ...
    var n = i(95), o = i(226), r = i(94), a = i(227), s = i(282), l = i(284);
    i(2).extendChartView({
    ...
    i(291), i(292), i(221), i(172), n.registerLayout(i(295)), n.registerVisual(i(296)), n.registerProcessor(o.PROCESSOR.STATISTIC, i(294)), n.registerPreprocessor(i(293)), i(77)("map", [{
    ...
    var n = i(14), o = i(15), r = i(1), a = i(30), s = i(9), l = s.encodeHTML, u = s.addCommas, h = i(66), c = i(172), d = o.extend({
      type: "series.map",
      layoutMode: "box",
      needsDrawMap: !1,
      seriesGroup: [],
    ...
    var n = i(2);
    i(230), i(298), i(299), n.registerVisual(i(300))
  }, function (t, e, i) {
    function n(t, e, i) {
    ...
    var l = i(3), u = i(1), h = .3, c = i(27).extend({
      type: "parallel", init: function () {
        ...
        if (c.diff(d).add(e).update(i).remove(s).execute(),
            a(c, m), !this._data) {
    ...
    var n = i(1), o = i(2);
    i(335), i(302), i(303), o.registerVisual(n.curry(i(72), "radar")), o.registerVisual(n.curry(i(46), "radar", "circle", null)), o.registerLayout(i(305)), o.registerProcessor(n.curry(i(70), "radar")), o.registerPreprocessor(i(304))
  }, function (t, e, i) {
    "use strict";
    var n = i(15), o = i(14), r = i(30), a = i(1), s = n.extend({
      type: "series.radar",
      dependencies: ["radar"],
      init: function (t) {
      ...
      type: "radar", render: function (t, e, i) {
        function s(t, e) {
          ...
          if ("none" !== i) {
            ...
            return r.attr({style: {strokeNoScale: !0}, z2: 100, scale: n(t.getItemVisual(e, "symbolSize"))}), r
          }
        }
    ...
    var n = i(2);
    i(307), i(308), n.registerLayout(i(309)), n.registerVisual(i(310))
  }, function (t, e, i) {
    var n = i(15), o = i(228), r = n.extend({
      type: "series.sankey",
      layoutInfo: null,
      getInitialData: function (t) {
      ...
      defaultOption: {
        ...
        nodeGap: 8,
        layoutIterations: 32,
        label: {normal: {show: !0, position: "right", textStyle: {color: "#000", fontSize: 12}}, emphasis: {show: !0}},
    ...
    t.exports = function (t, e) {
      t.eachSeriesByType("sankey", function (t) {
        ...
        var o = i[0].getLayout().value, r = i[i.length - 1].getLayout().value;
    ...
    var n = i(2);
    i(313), i(314), i(315), n.registerVisual(i(317)), n.registerLayout(i(316))
  }, function (t, e, i) {
    function n(t) {
    ...
    var a = i(3), s = i(13), l = i(1), u = i(78), h = 8, c = 8, d = 5;
    n.prototype = {
      constructor: n, render: function (t, e, i, n) {
        ...
        if (r.removeAll(), o.get("show") && i) {
          ...
          this._prepare(i, u, l), this._renderContent(t, u, a, l, n), s.positionGroup(r, u.pos, u.box)
        }
    ...
    var r = i(15), a = i(380), s = i(1), l = i(10), u = i(9), h = i(78), c = u.encodeHTML, d = u.addCommas;
    t.exports = r.extend({
      type: "series.treemap",
      dependencies: ["grid", "polar"],
      _viewRoot: null,
      ...
      if (u) {
        ...
        if (I && I.isInView) {
          ...
          if (k) {
            ...
            z && (z.setShape({x: 0, y: 0, width: A, height: L}), p(z, function () {
    ...
    var a = i(1), s = i(3), l = i(45), u = i(78), h = i(312), c = i(79), d = i(8), f = i(19), p = i(381), g = a.bind, m = s.Group, v = s.Rect, y = a.each, x = 3, _ = ["label", "normal"], b = ["label", "emphasis"], w = 10, S = 1, M = 2;
    t.exports = i(2).extendChartView({
    ...
    for (var n = i(2), o = i(78), r = function () {
    ...
    var p = i(1), g = i(4), m = i(13), v = i(78), y = i(8), v = i(78), x = Math.max, _ = Math.min, b = g.parsePercent, w = p.retrieve, S = p.each;
    t.exports = n
  }, function (t, e, i) {
    ...
    var o = i(1), r = i(50), a = i(113), s = i(3), l = ["axisLine", "axisLabel", "axisTick", "axisName"], u = i(2).extendComponentView({
      type: "parallelAxis",
      init: function (t, e) {
      ...
      _refreshBrushController: function (t, e, i, n) {
        var r = i.axis, a = o.map(i.activeIntervals, function (t) {
          return {brushType: "lineX", panelId: "pl", range: [r.dataToCoord(t[0], !0), r.dataToCoord(t[1], !0)]}
    ...
    var o = i(1), r = i(3), a = i(50), s = ["axisLine", "axisLabel", "axisTick", "axisName"], l = ["splitLine", "splitArea"];
    i(2).extendComponentView({
    ...
    var o = i(50), r = i(1), a = i(3), s = o.getInterval, l = o.ifIgnoreOnTick, u = ["axisLine", "axisLabel", "axisTick", "axisName"], h = "splitLine", c = i(2).extendComponentView({
      type: "singleAxis",
      render: function (t, e) {
        var i = this.group;
        i.removeAll();
    ...
    i(2).registerPreprocessor(i(328)), i(330), i(325), i(326), i(327), i(348)
  }, function (t, e, i) {
    var n = i(2), o = i(1), r = i(173), a = i(10), s = ["#ddd"], l = n.extendComponentModel({
      ...
      defaultOption: {
        ...
        brushMode: "single",
        transformable: !0,
        brushStyle: {borderWidth: 1, color: "rgba(120,140,180,0.3)", borderColor: "rgba(120,140,180,0.8)", width: null},
    ...
    var h = i(2), c = i(173), d = i(1), f = i(8), p = i(329), g = i(83), m = i(114), v = ["inBrush", "outOfBrush"], y = "__ecBrushSelect", x = "__ecInBrushSelectEvent", _ = h.PRIORITY.VISUAL.BRUSH;
    ...
    "use strict";
    i(216), i(318), i(337), i(2).extendComponentView({type: "polar"})
  }, function (t, e, i) {
    i(373), i(374), i(336)
  }, function (t, e, i) {
    var n = i(50), o = i(1), r = i(3), a = ["axisLine", "axisLabel", "axisTick", "axisName"];
    t.exports = i(2).extendComponentView({
      type: "radar", render: function (t, e, i) {
        var n = this.group;
        ...
        if (a.length) {
          ...
          o.each(v, function (t, e) {
            this.group.add(r.mergePath(t, {style: o.defaults({stroke: "none", fill: g[e % g.length]}, L), silent: !0}))
          }, this), o.each(m, function (t, e) {
            this.group.add(r.mergePath(t, {style: o.defaults({fill: "none", stroke: p[e % p.length]}, A), silent: !0}))
          }, this)
        }
      }
    })
    ...
    var n = i(2);
    n.registerPreprocessor(i(345)), i(347), i(346), i(340), i(341)
  }, function (t, e, i) {
    var n = i(343), o = i(1), r = i(7), a = n.extend({
    ...
    var s = i(1), l = i(3), u = i(13), h = i(344), c = i(342), d = i(26), f = i(22), p = i(8), g = i(19), m = i(4), v = i(9), y = v.encodeHTML, x = s.bind, _ = s.each, b = Math.PI;
    t.exports = h.extend({
    ...
    var n = i(12), o = i(14), r = i(1), a = i(7), s = n.extend({
      type: "timeline",
      layoutMode: "box",
      defaultOption: {
        zlevel: 0,
    ...
    function o(t) {
      ...
      a.each(n, function (t, e) {
        s[e] || r(o, e) || (o[e] = t)
      }), i.label && !r(n, "emphasis") && (n.emphasis = i.label,
        delete i.label)
    }
    ...
    i(12).registerSubTypeDefaulter("timeline", function () {
      return "slider"
    })
  }, function (t, e, i) {
    "use strict";
    ...
    function n(t, e, i) {
      ...
      if (!n)return i.slice();
      var o = n.option.visual.length;
      if (o <= 1 || i[0] === i[1])return i.slice();
      for (var r = (i[1] - i[0]) / (o - 1), a = i[0], s = [], l = 0; l < o && a < i[1]; l++)s.push(a), a += r;
      return s.push(i[1]), s
    }
    ...
    function o(t, e, i, o) {
      var r = n(t, e, i);
      a.each(r, function (t) {
        for (var i = {value: t, valueState: e}, n = 0, r = 0; r < o.length; r++) {
          if (n |= "inRange" === o[r].valueState, t < o[r].value)return void o.splice(r, 0, i);
          n && (o[r].valueState = "inRange")
        }
        o.push(i)
      })
    }

    var r = i(231), a = i(1), s = i(4), l = [20, 140], u = r.extend({
      ...
      getStops: function (t, e) {
        var i = [];
        return o(this, "outOfRange", this.getExtent(), i), o(this, "inRange", this.option.range.slice(), i), a.each(i, function (t) {
    ...
    var l = i(232), u = i(3), h = i(1), c = i(4), d = i(80), f = i(87), p = i(233), g = i(7), m = c.linearMap, v = h.each, y = Math.min, x = Math.max, _ = 12, b = 6, w = l.extend({
      type: "visualMap.continuous",
      init: function () {
    ...
    function o(t) {
      ...
      for (var i = -(1 / 0), n = 0; n < t.length; n++)for (var o = t[n].interval, r = t[n].close, a = 0; a < 2; a++)o[a] < i && (o[a] = i, r[a] = 1 - a), i = o[a]
    }

    var r = i(231), a = i(1), s = i(71), l = r.extend({
      ...
      findTargetDataIndices: function (t) {
        ...
        return this.eachTargetSeries(function (i) {
          var n = [], o = i.getData();
          o.each(this.getDataDimension(o), function (e, i) {
            var o = s.findPieceIndex(e, this._pieceList);
            o === t && n.push(i)
          }, !0, this), e.push({seriesId: i.id, dataIndex: n})
        }, this), e
      },
      ...
      getStops: function (t, e) {
        function i(t) {
          n.push(t), t.color = e(o, o.getRepresentValue(t), t.valueState)
        }

        var n = [], o = this, r = -(1 / 0);
        return a.each(this._pieceList, function (t) {
          var e = t.interval;
          e && (e[0] > r && i({interval: [r, e[0]], valueState: "outOfRange"}), i({
            interval: e.slice(),
      ...
      splitNumber: function () {
        var t = this.option, e = this._pieceList, i = t.precision, n = this.getExtent(), r = t.splitNumber;
        r = Math.max(parseInt(r, 10), 1), t.splitNumber = r;
        for (var s = (n[1] - n[0]) / r; +s.toFixed(i) !== s && i < 5;)i++;
        t.precision = i, s = +s.toFixed(i);
        var l = 0;
        t.minOpen && e.push({index: l++, interval: [-(1 / 0), n[0]], close: [0, 0]});
        for (var u = n[0], h = l + r; l < h; u += s) {
          var c = l === r - 1 ? n[1] : u + s;
          e.push({index: l++, interval: [u, c], close: [1, 1]})
        }
        t.maxOpen && e.push({index: l++, interval: [n[1], 1 / 0], close: [0, 0]}), o(e), a.each(e, function (t) {
        ...
        a.each(t.pieces, function (t, i) {
          ...
          if (null != t.label && (n.text = t.label), t.hasOwnProperty("value")) {
            ...
            for (var r = n.interval = [], l = n.close = [0, 0], u = [1, 0, 1], h = [-(1 / 0), 1 / 0], c = [], d = 0; d < 2; d++) {
              for (var f = [["gte", "gt", "min"], ["lte", "lt", "max"]][d], p = 0; p < 3 && null == r[d]; p++)r[d] = t[f[p]], l[d] = u[p], c[d] = 2 === p;
              null == r[d] && (r[d] = h[d])
            }
            c[0] && r[1] === 1 / 0 && (l[0] = 0), c[1] && r[0] === -(1 / 0) && (l[1] = 0), r[0] === r[1] && l[0] && l[1] && (n.value = r[0])
          }
          n.visual = s.retrieveVisuals(t), e.push(n)
        }, this), n(t, e), o(e), a.each(e, function (t) {
    ...
    var n = i(232), o = i(1), r = i(3), a = i(26), s = i(13), l = i(233), u = n.extend({
      type: "visualMap.piecewise",
      doRender: function () {
        function t(t) {
    ...
    i(2).registerPreprocessor(i(234)), i(235), i(236), i(350), i(351), i(237)
  }, function (t, e, i) {
    i(2).registerPreprocessor(i(234)), i(235), i(236), i(352), i(353), i(237)
  }, function (t, e, i) {
    function n(t, e, i, n, o) {
    ...
    var r = i(361), a = i(1), s = i(8), l = i(238), u = [i(359), i(360), i(358)];
    n.prototype = {
    ...
    "use strict";
    var n = i(7), o = i(12), r = i(10), a = i(1), s = i(66), l = i(172), u = o.extend({
      type: "geo",
      coordinateSystem: null,
      layoutMode: "box",
      init: function (t) {
    ...
    var o = i(12), r = i(1), a = i(31), s = i(52), l = i(4), u = o.extend({
    ...
    r.merge(u.prototype, i(51)), s("parallel", u, n, h), t.exports = u
  }, function (t, e, i) {
    function n(t, e, i) {
      this._axesMap = {}, this._axesLayout = {}, this.dimensions = t.dimensions, this._rect, this._model = t, this._init(t, e, i)
    }

    var o = i(13), r = i(22), a = i(1), s = i(364), l = i(3), u = i(19), h = a.each, c = Math.PI;
    n.prototype = {
    ...
    var o = i(1), r = i(12), a = i(52), s = r.extend({type: "polarAxis", axis: null});
    ...
    "use strict";
    var n = i(371), o = i(367), r = function (t) {
    ...
    "use strict";
    i(368), i(2).extendComponentModel({
      type: "polar",
    ...
    var o = i(1), r = i(372), a = i(38), s = i(4), l = i(22);
    ...
    var o = i(81), r = o.valueAxis, a = i(10), s = i(1), l = i(51), u = i(2).extendComponentModel({
      type: "radar",
      optionUpdated: function () {
        var t = this.get("boundaryGap"), e = this.get("splitNumber"), i = this.get("scale"), n = this.get("axisLine"), o = this.get("axisTick"), r = this.get("axisLabel"), u = this.get("name.textStyle"), h = this.get("name.show"), c = this.get("name.formatter"), d = this.get("nameGap"), f = this.get("triggerEvent"), p = s.map(this.get("indicator") || [], function (p) {
          null != p.max && p.max > 0 && !p.min ? p.min = 0 : null != p.min && p.min < 0 && !p.max && (p.max = 0), p = s.merge(s.clone(p), {
            boundaryGap: t,
            splitNumber: e,
            scale: i,
            axisLine: n,
            ...
            nameTextStyle: u,
            triggerEvent: f
          }, !1), h || (p.name = ""), "string" == typeof c ? p.name = c.replace("{value}", p.name) : "function" == typeof c && (p.name = c(p.name, p));
          var g = s.extend(new a(p, null, this.ecModel), l);
    ...
    var o = i(12), r = i(52), a = i(1), s = o.extend({
      type: "singleAxis",
      layoutMode: "box",
      axis: null,
      coordinateSystem: null
    ...
    var r = i(1), a = i(10), s = i(14), l = i(241), u = i(30), h = function (t, e) {
